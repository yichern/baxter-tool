...
register(
    ...
    entry_point='gym.envs.baxter.tasks.reach:BaxterReachEnv',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v5',
    entry_point='gym.envs.baxter.tasks.reach:BaxterReachEnv_5',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v6',
    entry_point='gym.envs.baxter.tasks.reach:BaxterReachEnv_6',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v7',
    entry_point='gym.envs.baxter.tasks.reach:BaxterReachEnv_7',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v8',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_8',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v9',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_9',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v10',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_10',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v11',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_11',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v12',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_12',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v15',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_15',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v16',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_16',
    max_episode_steps=100,
)

register(
    id='BaxterReachEnv-v17',
    entry_point='gym.envs.baxter.tasks.reach_rot:BaxterReachEnv_17',
    max_episode_steps=100,
)
