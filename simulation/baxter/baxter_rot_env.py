...
class BaxterRotEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(BaxterRotEnv, self).__init__(
    ...
    def _set_action(self, action):
        ...
        pos_ctrl, gripper_ctrl, rot_ctrl = action[:3], action[3], action[4:8]
    ...
    # THIS DETERMINES THE TARGET GOAL LOCATION!!!
